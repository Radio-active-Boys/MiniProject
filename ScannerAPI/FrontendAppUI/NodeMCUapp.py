...
class BluetoothScannerApp:
    ...
    def init_gui(self):
        ...
        # MongoDB Settings Frame
        self.mongodb_settings_frame = tk.LabelFrame(self.main_frame, text="MongoDB Settings")
        self.mongodb_settings_frame.grid(row=0, column=0, padx=padx, pady=pady, sticky="ew")

        # MongoDB URI
        self.mongodb_uri_label = tk.Label(self.mongodb_settings_frame, text="MongoDB URI:")
        self.mongodb_uri_label.grid(row=0, column=0, padx=padx, pady=pady, sticky="e")
        self.mongodb_uri_entry = tk.Entry(self.mongodb_settings_frame)
        self.mongodb_uri_entry.grid(row=0, column=1, padx=padx, pady=pady)

        # Database Name
        self.db_name_label = tk.Label(self.mongodb_settings_frame, text="Database Name:")
        self.db_name_label.grid(row=1, column=0, padx=padx, pady=pady, sticky="e")
        self.db_name_entry = tk.Entry(self.mongodb_settings_frame)
        self.db_name_entry.grid(row=1, column=1, padx=padx, pady=pady)

        # Collection Name
        self.collection_name_label = tk.Label(self.mongodb_settings_frame, text="Collection Name:")
        self.collection_name_label.grid(row=2, column=0, padx=padx, pady=pady, sticky="e")
        self.collection_name_entry = tk.Entry(self.mongodb_settings_frame)
        self.collection_name_entry.grid(row=2, column=1, padx=padx, pady=pady)

        # Node Name
        self.node_name_label = tk.Label(self.mongodb_settings_frame, text="Node Name:")
        self.node_name_label.grid(row=3, column=0, padx=padx, pady=pady, sticky="e")
        self.node_name_entry = tk.Entry(self.mongodb_settings_frame)
        self.node_name_entry.grid(row=3, column=1, padx=padx, pady=pady)

        # Store Option Frame
        self.store_option_var = tk.IntVar()
        self.store_option_var.set(2)  # Default: Store locally
        self.store_option_frame = tk.LabelFrame(self.main_frame, text="Store Option")
        self.store_option_frame.grid(row=1, column=0, padx=padx, pady=pady, sticky="ew")

        # Store in MongoDB Radio Button
        ...
        self.mongodb_radio_button.grid(row=0, column=0, padx=padx, pady=pady)

        # Store Locally Radio Button
        ...
        self.local_csv_radio_button.grid(row=0, column=1, padx=padx, pady=pady)

        # Action Buttons Frame
        self.action_buttons_frame = tk.Frame(self.main_frame)
        self.action_buttons_frame.grid(row=2, column=0, padx=padx, pady=pady, sticky="ew")

        # Start Scanning Button
        self.start_scanning_button = tk.Button(self.action_buttons_frame, text="Start Scanning", command=self.start_scanning)
        self.start_scanning_button.grid(row=0, column=0, padx=padx, pady=pady)

        # Stop Scanning Button
        self.stop_scanning_button = tk.Button(self.action_buttons_frame, text="Stop Scanning", command=self.stop_scanning)
        self.stop_scanning_button.grid(row=0, column=1, padx=padx, pady=pady)

        # Output Frame
        self.output_frame = tk.LabelFrame(self.main_frame, text="Scanned Devices")
        self.output_frame.grid(row=3, column=0, padx=padx, pady=pady, sticky="ew")

        # Scanned Devices Output
        self.output_text = tk.Text(self.output_frame, wrap="word", height=10)
        self.output_text.grid(row=0, column=0, padx=padx, pady=pady, sticky="nsew")

        # Scrollbars for Output Text
        self.scrollbar_y = tk.Scrollbar(self.output_frame, orient="vertical", command=self.output_text.yview)
        self.scrollbar_y.grid(row=0, column=1, sticky="ns")
        self.scrollbar_x = tk.Scrollbar(self.output_frame, orient="horizontal", command=self.output_text.xview)
        self.scrollbar_x.grid(row=1, column=0, sticky="ew")

        self.output_text.config(yscrollcommand=self.scrollbar_y.set, xscrollcommand=self.scrollbar_x.set)
