...
file1_path = r'data\data28Junee\Admin1_data_28_june.json'
file2_path = r'data\data28Junee\Admin2_data_28_june.json'
output_file_path = r'data\data28Junee\merged_file.json'
